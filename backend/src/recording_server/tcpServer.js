...
const { AudioRecorder } = require("./server");
...
// frontendIoServer.on("connection", (socket) => {
//   console.log(`new frontend client has connected, id: ${socket.id}`);

//   socket.emit("recordingsStatus", recordings);
// });
